...
- Install deps (workspaces): `npm install` (Node 18+; repo attuale Node 22.14.0).
...
- Mobile UI (submodule `UI`): `npm --workspace UI run dev|build`; copia il bundle in `apps/pwa/public/mobile/` quando serve.
