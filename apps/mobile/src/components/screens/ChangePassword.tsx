      ...
      <div className="flex h-full flex-col">
        ...
        <div className="mt-4 flex flex-col items-start gap-1">
          ...
          <p className="text-[16px] leading-[25.6px] text-[#aeaeb2]">
            Account: <span className="text-white">{email || 'â€”'}</span>
          </p>
          {isRecovery ? (
            <p className="text-[14px] leading-[20px] text-[#8e8e93] !m-0 mt-2">
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex w-full max-w-[300px] flex-col gap-6 mx-auto">
          <div className="flex flex-col gap-4 w-full">
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <div
                  className={`bg-[#2c2c2e] border-2 ${
                    errors.currentPassword ? 'border-[#ff453a]' : 'border-[#3a3a3c]'
                ...
                {errors.currentPassword ? (
                  <p className="text-[14px] leading-[20px] text-[#ff453a] !m-0">
                    {errors.currentPassword}
                  </p>
                ) : null}
                ...
                <button
                  ...
                  className="self-end text-[14px] leading-[20px] text-[#0a84ff] underline underline-offset-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                ...
                {resetEmailError ? (
                  <p className="text-[14px] leading-[20px] text-[#ff453a] !m-0">{resetEmailError}</p>
                ) : resetEmailStatus === 'sent' ? (
                  <p className="text-[14px] leading-[20px] text-[#8e8e93] !m-0">
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              {errors.password ? (
                ...
                <p className="text-[14px] leading-[20px] text-[#8e8e93] !m-0">Almeno 8 caratteri</p>
              )}
            </div>
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="bg-gradient-to-b from-[#0066d6] to-[#0a84ff] h-[44px] w-full rounded-[16.4px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] disabled:opacity-60 disabled:cursor-not-allowed"
          >
