  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between p-6 bg-gradient-to-b from-[#0f0d0e] via-[#1a1617] to-[#2d0a0f]">
      ...
      <div className="w-full max-w-md animate-slide-up flex flex-col items-center justify-center gap-4">
        <Button variant="primary" size="lg" fullWidth onClick={onStart} style={{ maxWidth: "400px", margin: "0 20px", "@media (max-width: 640px)": { margin: "0 auto" } } as any}>
          Inizia
        </Button>

        <Button variant="secondary" size="lg" fullWidth onClick={onLogin} style={{ maxWidth: "400px", margin: "auto 0 20px", "@media (max-width: 640px)": { margin: "0 auto" } } as any}>
          Accedi
        </Button>
      </div>
    </div>
